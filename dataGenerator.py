...
class DataGenerator(keras.utils.Sequence):
    ...
    def __init__(self, imgList, list_IDs, transformParameters,batch_size=32, dim=(32,32,32), n_channels=1,
                 n_classes=10, shuffle=True, normalize=True,downsampling=True, dataAugmentation=True,downsamplingPercent=65):
        'Initialization'
        self.dim = dim
    ...
    def __data_generation(self, list_IDs_temp):
        ...
        for i, ID in enumerate(list_IDs_temp):
            ...
            if self.dataAugmentation == True:
                ...
                if activation < 0:
                    transformedM=datagen.apply_transform(transformedM,self.transformParameters)
