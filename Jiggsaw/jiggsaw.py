...
spec = importlib.util.spec_from_file_location("jiggsawFunctions.py", "../neuralNetworks/jiggsawNetwork.py")
jiggsawNetwork = importlib.util.module_from_spec(spec)
spec.loader.exec_module(jiggsawNetwork)
...
network=jiggsawNetwork.jiggsawNetwork(input_shape,numClasses)
...
model.save('./jiggsawModel.h5')
model.save_weights('./jiggsawlWeights.h5')