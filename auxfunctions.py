...
def calculateMeanStdClassification(path):
    ...
    with open('meanClassification.pickle', 'wb') as file:
        pickle.dump(train_mean, file, pickle.HIGHEST_PROTOCOL)

    with open('stdClassification.pickle', 'wb') as file:
        pickle.dump(train_std, file, pickle.HIGHEST_PROTOCOL)
